...
// 1) Finish Deployement !!
// 2) DO PYTHON DSA (CLASS + POINTER) -> TDP HACKARANK!!
// 3) TDP HACKARANK!!
        ...
        <div className="max-w-2xl mx-auto"> {/*Ensures the form doesn’t stretch too wide on big screens */}
          ...
          <div className="flex justify-between items-center">
            <Link to="/" className="btn btn-ghost mb-6">
              <ArrowLeft />
              Back to Note</Link>
            <div className="btn text-red-600 flex flex-row">
          ...
          <div className="card bg-base-100 ">
            <div className="card-body">
              <h2 className="card-title text-2xl mb-4"> Note Details Page </h2>
